package io.ddd4j.ai.cmpt.agent.autoconfigure;

import io.ddd4j.ai.cmpt.agent.properties.AgentProperties;
import io.ddd4j.ai.cmpt.agent.service.AgentService;
import io.ddd4j.ai.cmpt.agent.service.impl.PlanExecuteAgent;
import io.ddd4j.ai.cmpt.agent.service.impl.ReActAgent;
 ...
 */
@AutoConfiguration(afterName = "io.ddd4j.ai.cmpt.chat.autoconfigure.ChatAutoConfiguration")
