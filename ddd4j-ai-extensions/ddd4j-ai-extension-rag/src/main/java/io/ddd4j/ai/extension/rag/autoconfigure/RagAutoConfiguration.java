 ...
 */
@AutoConfiguration(after = {io.ddd4j.ai.extension.chat.autoconfigure.ChatAutoConfiguration.class,
        io.ddd4j.ai.extension.vectordb.autoconfigure.VectorDbAutoConfiguration.class})
