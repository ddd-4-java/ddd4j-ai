...
class MemoryServiceContractTest {
    ...
    private final MemoryService memory = new io.ddd4j.ai.cmpt.memory.service.impl.WindowMemoryService(
    ...
    void windowKeepsMostRecentMessagesOnly() {
        MemoryService small = new io.ddd4j.ai.cmpt.memory.service.impl.WindowMemoryService(
